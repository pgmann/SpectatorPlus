...
public class SpectatorsInventoryManager {
    ...
    private final static Material QUIT_NOCLIP_ITEM = Material.PLAYER_HEAD;
    ...
    private void fillSpectatorGamemodeInventory(Player player) {
        ...
        if (!Toggles.VANILLA_SPECTATOR_MODE.get()) {
            exit = GuiUtils.makeItem(new ItemStack(QUIT_NOCLIP_ITEM), getItemTitle(QUIT_NOCLIP_TITLE + player.getName(), CLICK), Arrays.asList(
